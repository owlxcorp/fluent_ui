...
class NavigationViewState extends State<NavigationView> {
  ...
  void initState() {
    ...
    _compactOverlayOpen = PageStorage.of(
          context,
        ).readState(context, identifier: 'compactOverlayOpen') as bool? ??
        false;
      ...
      builder: (context, consts) {
        ...
        return Mica(
          ...
          child: InheritedNavigationView(
            displayMode:
                _compactOverlayOpen ? PaneDisplayMode.open : displayMode,
            minimalPaneOpen: minimalPaneOpen,
            pane: widget.pane,
