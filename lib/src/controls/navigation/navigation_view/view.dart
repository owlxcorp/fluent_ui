...
///  * [TitleBar], the title bar displayed at the top
...
///   * [TitleBar], the new recommended replacement for this widget
@Deprecated(
  'Use TitleBar instead. '
  'NavigationAppBar will be removed in a future release. '
  'This message was added in fluent_ui 5.0.0.',
)
class NavigationAppBar with Diagnosticable {
  ...
  /// The height of the app bar. 50.0 is used by default
  final double height;
  ...
  /// The start padding of the title.
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DoubleProperty('height', height, defaultValue: 50.0));
  }
}
